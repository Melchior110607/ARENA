...
import { getCompanies, getOpportunities, getProducts, getTraceability } from "@/lib/api";
...
export default async function HomePage() {
  const [companies, products, opportunities, textileChain, constructionChain] = await Promise.all([
    getCompanies(),
    getProducts(),
    getOpportunities(),
